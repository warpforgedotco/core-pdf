...
if TYPE_CHECKING:
    ...
    from core_pdf.document.redactions import RedactionAnalysis, RedactionCandidate
...
class PdfPage:
    ...
    def structure(self):
        ...
        if structure is None:
            from core_pdf.document.structure import PageStructure
    ...
    def to_markdown(self) -> str:
        ...
        from core_pdf.layout.render import MarkdownRenderer
    ...
    def get_redaction_analysis(self) -> RedactionAnalysis:
        ...
        from core_pdf.document.redactions import RedactionAnalyzer
