...
from ..misc.configTools import AbstractConfig
from ..misc.loggingTools import deprecateArgument
from ..misc.textTools import Tag, byteord, tostr
from . import TTLibError
from .sfnt import SFNTReader, SFNTWriter
...
class TTFont(object):
    ...
    def _makeGlyphName(codepoint: int) -> str:
        from .. import agl  # Adobe Glyph List
    ...
    def normalizeLocation(self, location: Mapping[str, float]) -> dict[str, float]:
        ...
        """
        from ..varLib.models import normalizeLocation
...
def getTableModule(tag: str | bytes) -> ModuleType | None:
    ...
    try:
        import_module(f"{tables.__name__}.{pyTag}")
