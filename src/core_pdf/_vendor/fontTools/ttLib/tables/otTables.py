...
from .. import OPTIMIZE_FONT_SPEED
from .TupleVariation import TupleVariation
from .otTraverse import dfs_base_table
from ...misc.arrayTools import quantizeRect
from ...misc.roundTools import otRound
from ...misc.transform import Transform, Identity, DecomposedTransform
from ...misc.textTools import bytesjoin, pad, safeEval
from ...misc.vector import Vector
from ...pens.boundsPen import ControlBoundsPen
from ...pens.transformPen import TransformPen
from .otBase import (
    BaseTable,
...
from ...misc.fixedTools import (
    fixedToFloat as fi2fl,
    floatToFixed as fl2fi,
    floatToFixedToStr as fl2str,
    strToFixedToFloat as str2fl,
)
from ...feaLib.lookupDebugInfo import LookupDebugInfo, LOOKUP_DEBUG_INFO_KEY
import logging
import struct
import array
import sys
...
if TYPE_CHECKING:
    from ..ttGlyphSet import _TTGlyphSet
