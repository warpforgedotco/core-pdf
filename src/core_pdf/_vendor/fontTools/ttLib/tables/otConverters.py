...
from ...misc.roundTools import nearestMultipleShortestRepr, otRound
from ...misc.textTools import bytesjoin, tobytes, tostr, pad, safeEval
from ...misc.lazyTools import LazyList
from .. import OPTIMIZE_FONT_SPEED, getSearchRange
from .otBase import (
    CountReference,
...
class MappingEntriesConverter(BaseConverter):
    def read(self, reader, font, tableDict):
        from ...misc.fixedTools import fixedToFloat as fi2fl
        from ...misc.iftSparseBitSet import decode as sbsDecode
    ...
    def write(self, writer, font, tableDict, value, repeatIndex=None):
        from ...misc.iftSparseBitSet import encode as sbsEncode
