...
from ..misc.fixedTools import otRound, fixedToFloat as fi2fl
from ..misc.loggingTools import deprecateFunction
from ..misc.transform import Transform, DecomposedTransform
from ..pens.transformPen import TransformPen, TransformPointPen
from ..pens.recordingPen import (
...
class _TTGlyphSet(Mapping):
    ...
    def __init__(self, font, location, glyphsMapping, *, recalcBounds=True):
        ...
        self.hvarTable = None
        if location:
            from ..varLib.varStore import VarStoreInstancer
...
class _TTGlyph(ABC):
    ...
    def drawPoints(self, pen):
        ...
        how that works.
        """
        from ..pens.pointPen import SegmentToPointPen
...
class _TTGlyphGlyf(_TTGlyph):
    ...
    def _getGlyphInstance(self):
        from ..varLib.iup import iup_delta
        from .tables._g_l_y_f import GlyphCoordinates
        from ..varLib.models import supportScalar
...
class _TTGlyphVARC(_TTGlyph):
    def _draw(self, pen, isPointPen):
        ...
        from ..varLib.multiVarStore import MultiVarStoreInstancer
        from ..varLib.varStore import VarStoreInstancer
