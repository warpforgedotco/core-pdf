...
from ..misc.arrayTools import calcIntBounds
from ..misc.textTools import Tag, bytechr, byteord, bytesjoin, pad
from . import (
    TTFont,
    TTLibError,
    getTableModule,
...
from .tables import ttProgram, _g_l_y_f
import logging
...
def main(args=None):
    ...
    from ..ttx import makeOutputFileName
