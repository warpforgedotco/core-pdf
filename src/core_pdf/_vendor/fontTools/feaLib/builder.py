...
from ..misc import sstruct
from ..misc.textTools import Tag, tostr, binary2num, safeEval
from .error import FeatureLibError
from .lookupDebugInfo import (
    LookupDebugInfo,
...
from .variableScalar import VariableScalar, VariableScalarBuilder
from ..otlLib import builder as otl
from ..otlLib.maxContextCalc import maxCtxFont
from ..ttLib import newTable, getTableModule
from ..ttLib.tables import otBase, otTables
from ..otlLib.builder import (
...
from ..otlLib.error import OpenTypeLibError
from ..varLib.errors import VarLibError
from ..varLib.varStore import OnlineVarStoreBuilder
from ..varLib.builder import buildVarDevTable
from ..varLib.featureVars import addFeatureVariationsRaw
from ..varLib.models import normalizeValue, piecewiseLinearMap
