...
from .. import __init__ as fontTools
from ..misc import eexec
from ..misc.macCreatorType import getMacCreatorAndType
from ..misc.textTools import bytechr, byteord, bytesjoin, tobytes
from ..misc.psOperators import (
    _type1_pre_eexec_order,
    _type1_fontinfo_order,
    _type1_post_eexec_order,
)
from ..encodings.StandardEncoding import StandardEncoding
import os
import re
...
class T1Font(object):
    ...
    def parse(self):
        from ..misc import psLib
        from ..misc import psCharStrings
...
def readLWFN(path, onlyHeader=False):
    ...
    from ..misc.macRes import ResourceReader
