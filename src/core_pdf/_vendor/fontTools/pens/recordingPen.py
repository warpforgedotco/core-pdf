...
from .basePen import AbstractPen, DecomposingPen
from .pointPen import AbstractPointPen, DecomposingPointPen
...
class RecordingPen(AbstractPen):
    ...
    :Example:
        .. code-block::
            ...
            from .recordingPen import RecordingPen
...
class RecordingPointPen(AbstractPointPen):
    ...
    :Example:
        .. code-block::
            ...
            from .recordingPen import RecordingPointPen
