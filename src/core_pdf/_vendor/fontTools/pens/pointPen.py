...
from ..misc.enumTools import StrEnum
from ..misc.loggingTools import LogMixin
from ..misc.transform import DecomposedTransform, Identity
from .basePen import AbstractPen, MissingComponentError, PenError
...
class DecomposingPointPen(LogMixin, AbstractPointPen):
    ...
    def addComponent(self, baseGlyphName, transformation, identifier=None, **kwargs):
        ...
        """
        from .transformPen import TransformPointPen
            ...
            if self.reverseFlipped != ReverseFlipped.NO:
                ...
                if a * d - b * c < 0:
                    ...
                    if self.reverseFlipped == ReverseFlipped.ON_CURVE_FIRST:
                        from .filterPen import OnCurveFirstPointPen
