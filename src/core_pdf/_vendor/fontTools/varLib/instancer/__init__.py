...
from ..models import normalizeValue, piecewiseLinearMap
from ...ttLib import TTFont, newTable
from ...ttLib.tables.TupleVariation import TupleVariation
from ...ttLib.tables import _g_l_y_f
from ... import varLib
...
from ... import subset  # noqa: F401
from ...cffLib import privateDictOperators2
from ...cffLib.specializer import (
    programToCommands,
    commandsToProgram,
    specializeCommands,
    generalizeCommands,
)
from ...cffLib.CFF2ToCFF import convertCFF2ToCFF
from .. import builder
from ..mvar import MVAR_ENTRIES
from ..merger import MutatorMerger
from . import names
from .featureVars import instantiateFeatureVariations
from ...misc.cliTools import makeOutputFileName
from . import solver
from ...ttLib.tables.otTables import VarComponentFlags
import collections
import dataclasses
    ...
    *,
    ...
    if "fvar" not in varfont:
        if overlap == OverlapMode.KEEP_AND_SET_FLAGS:
            ...
            from ...ttLib.removeOverlaps import removeOverlaps
