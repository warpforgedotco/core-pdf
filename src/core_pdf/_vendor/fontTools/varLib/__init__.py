...
from ..misc.roundTools import noRound, otRound
from ..misc.fixedTools import floatToFixed as fl2fi
from ..misc.textTools import Tag, tostr
from ..ttLib import TTFont, newTable
from ..ttLib.tables._f_v_a_r import Axis, NamedInstance
from ..ttLib.tables._g_l_y_f import (
    GlyphCoordinates,
    dropImpliedOnCurvePoints,
    USE_MY_METRICS,
)
from ..ttLib.tables.ttProgram import Program
from ..ttLib.tables.TupleVariation import TupleVariation
from ..ttLib.tables import otTables as ot
from ..ttLib.tables.otBase import OTTableWriter
from . import builder, models, varStore
from .merger import VariationMerger, COLRVariationMerger
from .mvar import MVAR_ENTRIES
from .iup import iup_delta_optimize
from .featureVars import addFeatureVariations
from ..designspaceLib import DesignSpaceDocument, InstanceDescriptor
from ..designspaceLib.split import splitInterpolable, splitVariableFonts
from .stat import buildVFStatTable
from ..colorLib.builder import buildColrV1
from ..colorLib.unbuilder import unbuildColrV1
...
def _add_CFF2(varFont, model, master_fonts):
    ...
    if "CFF2" not in varFont:
        from ..cffLib.CFFToCFF2 import convertCFFToCFF2
