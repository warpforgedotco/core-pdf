...
import logging
from ..colorLib.builder import MAX_PAINT_COLR_LAYER_COUNT, LayerReuseCache
from ..misc import classifyTools
from ..misc.roundTools import otRound
from ..misc.treeTools import build_n_ary_tree
from ..ttLib.tables import otTables as ot
from ..ttLib.tables import otBase as otBase
from ..ttLib.tables.otConverters import BaseFixedValue
from ..ttLib.tables.otTraverse import dfs_base_table
from ..ttLib.tables.DefaultTable import DefaultTable
from . import builder, models, varStore
from .models import nonNone, allNone, allEqual, allEqualTo, subList
from .varStore import VarStoreInstancer
from functools import reduce
from ..otlLib.builder import buildSinglePos
from ..otlLib.optimize.gpos import (
