...
class Core14FontMetrics(TypedDict):
    widths: dict[str, int]
    props: dict[str, object]


GLYPH_NAME_ALIASES: dict[str, str] = {
    "quotereversed": "‛",
    "quoteleft": "‘",
    "quoteright": "’",
    "quotedblleft": "“",
...
SYMBOL_GLYPH_NAME_ALIASES: dict[str, str] = {
    "universal": "∀",
    "existential": "∃",
    "congruent": "≅",
    "approxequal": "≈",
...
# with Helvetica's advances, as Annex D.1 and every other reader assume.
...
FONT_DATA: dict[str, Core14FontMetrics] = {
    name: internal_STANDARD_14[record] for name, record in internal_METRIC_RECORD_NAMES.items()
}
