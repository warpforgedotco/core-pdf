...
# parse.ocr itself stays unimported until a page actually needs recognition.
...
def __getattr__(name: str) -> Any:
    ...
    Importing ``parse.ocr`` binds tesserocr and PIL, which a native-text
    document never touches. Keeping the re-export lazy leaves that cost on the
    OCR path where it belongs.
    """
