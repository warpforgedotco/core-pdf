...
from core_pdf.impl.third_party._vendor.fontTools.misc.roundTools import nearestMultipleShortestRepr, otRound
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import bytesjoin, tobytes, tostr, pad, safeEval
from core_pdf.impl.third_party._vendor.fontTools.misc.lazyTools import LazyList
from core_pdf.impl.third_party._vendor.fontTools.ttLib import OPTIMIZE_FONT_SPEED, getSearchRange
from .otBase import (
    CountReference,
...
class MappingEntriesConverter(BaseConverter):
    def read(self, reader, font, tableDict):
        ...
        from core_pdf.impl.third_party._vendor.fontTools.misc.iftSparseBitSet import decode as sbsDecode
    ...
    def write(self, writer, font, tableDict, value, repeatIndex=None):
        from core_pdf.impl.third_party._vendor.fontTools.misc.iftSparseBitSet import encode as sbsEncode
