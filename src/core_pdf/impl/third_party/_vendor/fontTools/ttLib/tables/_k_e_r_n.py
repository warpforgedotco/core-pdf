...
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import safeEval, readHex
from core_pdf.impl.third_party._vendor.fontTools.misc.fixedTools import fixedToFloat as fi2fl, floatToFixed as fl2fi
