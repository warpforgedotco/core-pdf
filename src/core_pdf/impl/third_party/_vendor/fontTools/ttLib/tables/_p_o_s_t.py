...
from core_pdf.impl.third_party._vendor.fontTools.ttLib.standardGlyphOrder import standardGlyphOrder
from core_pdf.impl.third_party._vendor.fontTools.misc import sstruct
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import bytechr, byteord, tobytes, tostr, safeEval, readHex
...
class table__p_o_s_t(DefaultTable.DefaultTable):
    ...
    def decode_format_4_0(self, data, ttFont):
        from core_pdf.impl.third_party._vendor.fontTools import agl
