...
from core_pdf.impl.third_party._vendor.fontTools.misc.lazyTools import LazyDict
...
import struct
import sys
import core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.TupleVariation as tv
