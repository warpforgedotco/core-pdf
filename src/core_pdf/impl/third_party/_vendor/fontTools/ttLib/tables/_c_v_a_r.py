...
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import bytesjoin
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.TupleVariation import (
