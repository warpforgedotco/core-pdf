...
from core_pdf.impl.third_party._vendor.fontTools.config import Config
from core_pdf.impl.third_party._vendor.fontTools.misc import xmlWriter
from core_pdf.impl.third_party._vendor.fontTools.misc.configTools import AbstractConfig
from core_pdf.impl.third_party._vendor.fontTools.misc.loggingTools import deprecateArgument
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import Tag, byteord, tostr
from core_pdf.impl.third_party._vendor.fontTools.ttLib import TTLibError
from core_pdf.impl.third_party._vendor.fontTools.ttLib.sfnt import SFNTReader, SFNTWriter
from core_pdf.impl.third_party._vendor.fontTools.ttLib.ttGlyphSet import (
    _TTGlyph,  # noqa: F401
    _TTGlyphSet,
    _TTGlyphSetCFF,
    _TTGlyphSetGlyf,
...
if TYPE_CHECKING:
    ...
    from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables import (
        B_A_S_E_,
        C_B_D_T_,
        C_B_L_C_,
        C_F_F_,
    ...
    from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.DefaultTable import DefaultTable
...
class TTFont(object):
    ...
    def _saveXML(
        ...
        if writeVersion:
            from core_pdf.impl.third_party._vendor.fontTools import version
    ...
    def importXML(
        ...
        from core_pdf.impl.third_party._vendor.fontTools.misc import xmlReader
    ...
    def _makeGlyphName(codepoint: int) -> str:
        from core_pdf.impl.third_party._vendor.fontTools import agl  # Adobe Glyph List
    ...
    def getGlyphNames2(self) -> list[str]:
        ...
        """
        from core_pdf.impl.third_party._vendor.fontTools.misc import textTools
    ...
    def normalizeLocation(self, location: Mapping[str, float]) -> dict[str, float]:
        ...
        """
        from core_pdf.impl.third_party._vendor.fontTools.varLib.models import normalizeLocation
...
def getTableModule(tag: str | bytes) -> ModuleType | None:
    ...
    try:
        __import__("core_pdf.impl.third_party._vendor.fontTools.ttLib.tables." + pyTag)
