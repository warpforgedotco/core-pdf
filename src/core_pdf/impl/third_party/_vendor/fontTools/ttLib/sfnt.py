...
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import Tag
from core_pdf.impl.third_party._vendor.fontTools.misc import sstruct
from core_pdf.impl.third_party._vendor.fontTools.ttLib import TTLibError, TTLibFileIsCollectionError
import struct
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if args and cls is SFNTReader:
            ...
            if sfntVersion == "wOF2":
                ...
                from core_pdf.impl.third_party._vendor.fontTools.ttLib.woff2 import WOFF2Reader
...
class SFNTWriter(object):
    def __new__(cls, *args, **kwargs):
        ...
        if cls is SFNTWriter:
            if flavor == "woff2":
                ...
                from core_pdf.impl.third_party._vendor.fontTools.ttLib.woff2 import WOFF2Writer
    ...
    def __init__(
        ...
        if self.flavor == "woff":
            ...
            from core_pdf.impl.third_party._vendor.fontTools.ttLib import getSearchRange
