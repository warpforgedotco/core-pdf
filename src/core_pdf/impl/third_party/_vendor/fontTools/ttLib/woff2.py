...
from core_pdf.impl.third_party._vendor.fontTools.misc.arrayTools import calcIntBounds
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import Tag, bytechr, byteord, bytesjoin, pad
from core_pdf.impl.third_party._vendor.fontTools.ttLib import (
    TTFont,
    TTLibError,
    getTableModule,
    getTableClass,
...
from core_pdf.impl.third_party._vendor.fontTools.ttLib.sfnt import (
    SFNTReader,
    SFNTWriter,
    DirectoryEntry,
    WOFFFlavorData,
...
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables import ttProgram, _g_l_y_f
import logging
...
def main(args=None):
    ...
    from core_pdf.impl.third_party._vendor.fontTools.ttx import makeOutputFileName
