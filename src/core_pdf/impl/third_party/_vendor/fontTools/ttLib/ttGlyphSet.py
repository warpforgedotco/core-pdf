...
from core_pdf.impl.third_party._vendor.fontTools.misc.fixedTools import otRound, fixedToFloat as fi2fl
from core_pdf.impl.third_party._vendor.fontTools.misc.loggingTools import deprecateFunction
from core_pdf.impl.third_party._vendor.fontTools.misc.transform import Transform, DecomposedTransform
...
class _TTGlyph(ABC):
    ...
    def drawPoints(self, pen):
        ...
        how that works.
        """
        from core_pdf.impl.third_party._vendor.fontTools.pens.pointPen import SegmentToPointPen
...
class _TTGlyphGlyf(_TTGlyph):
    ...
    def _getGlyphInstance(self):
        ...
        from core_pdf.impl.third_party._vendor.fontTools.varLib.models import supportScalar
...
class _TTGlyphVARC(_TTGlyph):
    def _draw(self, pen, isPointPen):
        ...
        how that works.
        """
        from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.otTables import (
            VarComponentFlags,
            NO_VARIATION_INDEX,
        )
        ...
        from core_pdf.impl.third_party._vendor.fontTools.varLib.multiVarStore import MultiVarStoreInstancer
        from core_pdf.impl.third_party._vendor.fontTools.varLib.varStore import VarStoreInstancer
