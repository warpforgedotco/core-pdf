...
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.otBase import (
    ValueRecord,
    valueRecordFormatDict,
    OTLOffsetOverflowError,
    OTTableWriter,
)
from core_pdf.impl.third_party._vendor.fontTools.ttLib.ttFont import TTFont
from core_pdf.impl.third_party._vendor.fontTools.feaLib.ast import STATNameStatement
