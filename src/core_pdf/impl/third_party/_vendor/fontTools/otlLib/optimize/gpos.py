...
from core_pdf.impl.third_party._vendor.fontTools.misc.intTools import bit_count, bit_indices
...
def compact_class_pairs(
    ...
    from core_pdf.impl.third_party._vendor.fontTools.otlLib.builder import buildPairPosClassesSubtable
