import core_pdf.impl.third_party._vendor.fontTools.voltLib.ast as ast
from core_pdf.impl.third_party._vendor.fontTools.voltLib.lexer import Lexer
from core_pdf.impl.third_party._vendor.fontTools.voltLib.error import VoltLibError
from io import open
