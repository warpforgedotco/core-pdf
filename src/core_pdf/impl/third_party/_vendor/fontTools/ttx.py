...
from core_pdf.impl.third_party._vendor.fontTools.ttLib import OPTIMIZE_FONT_SPEED, TTFont, TTLibError
from core_pdf.impl.third_party._vendor.fontTools.misc.macCreatorType import getMacCreatorAndType
from core_pdf.impl.third_party._vendor.fontTools.unicode import setUnicodeData
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import Tag, tostr
from core_pdf.impl.third_party._vendor.fontTools.misc.timeTools import timestampSinceEpoch
...
def ttList(input, output, options):
    ...
    for tag in tags:
        ...
        if ttf.flavor == "woff2":
            ...
            from core_pdf.impl.third_party._vendor.fontTools.ttLib.sfnt import calcChecksum
