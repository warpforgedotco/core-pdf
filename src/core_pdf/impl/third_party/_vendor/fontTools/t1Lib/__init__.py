...
from core_pdf.impl.third_party._vendor import fontTools
from core_pdf.impl.third_party._vendor.fontTools.misc import eexec
from core_pdf.impl.third_party._vendor.fontTools.misc.macCreatorType import getMacCreatorAndType
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import bytechr, byteord, bytesjoin, tobytes
from core_pdf.impl.third_party._vendor.fontTools.misc.psOperators import (
...
class T1Font(object):
    ...
    def parse(self):
        from core_pdf.impl.third_party._vendor.fontTools.misc import psLib
...
def readLWFN(path, onlyHeader=False):
    ...
    from core_pdf.impl.third_party._vendor.fontTools.misc.macRes import ResourceReader
