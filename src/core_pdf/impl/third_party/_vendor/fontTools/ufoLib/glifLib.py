...
import core_pdf.impl.third_party._vendor.fontTools.misc.filesystem as fs
from core_pdf.impl.third_party._vendor.fontTools.misc import etree, plistlib
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import tobytes
from core_pdf.impl.third_party._vendor.fontTools.pens.pointPen import AbstractPointPen, PointToSegmentPen
from core_pdf.impl.third_party._vendor.fontTools.ufoLib import UFOFormatVersion, _UFOBaseIO
from core_pdf.impl.third_party._vendor.fontTools.ufoLib.errors import GlifLibError
from core_pdf.impl.third_party._vendor.fontTools.ufoLib.filenames import userNameToFileName
from core_pdf.impl.third_party._vendor.fontTools.ufoLib.utils import (
    BaseFormatVersion,
    normalizeFormatVersion,
    numberTypes,
)
from core_pdf.impl.third_party._vendor.fontTools.ufoLib.validators import (
    anchorsValidator,
    colorValidator,
...
if TYPE_CHECKING:
    ...
    from core_pdf.impl.third_party._vendor.fontTools.annotations import (
        ElementType,
        FormatVersion,
        FormatVersions,
    ...
    from core_pdf.impl.third_party._vendor.fontTools.misc.filesystem._base import FS
...
class GlyphSet(_UFOBaseIO):
    ...
    def __init__(
        ...
        try:
            ...
            from core_pdf.impl.third_party._vendor.fontTools.ufoLib.errors import UnsupportedUFOFormat
    ...
    def writeGlyph(
        ...
        if formatVersion is None:
            ...
            try:
                ...
                from core_pdf.impl.third_party._vendor.fontTools.ufoLib.errors import UnsupportedGLIFFormat
