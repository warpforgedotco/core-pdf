...
from core_pdf.impl.third_party._vendor.fontTools.annotations import IntFloat
from core_pdf.impl.third_party._vendor.fontTools.ufoLib.utils import numberTypes
