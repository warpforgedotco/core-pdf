...
from core_pdf.impl.third_party._vendor.fontTools.misc.plistlib import dump, dumps, load, loads
...
from core_pdf.impl.third_party._vendor.fontTools.ufoLib.utils import deprecated
