...
```python
from core_pdf.impl.third_party._vendor.fontTools.fontBuilder import FontBuilder
...
class FontBuilder(object):
    ...
    def setupCOLR(
        ...
        """
        from core_pdf.impl.third_party._vendor.fontTools.colorLib.builder import buildCOLR
    ...
    def setupCPAL(
        ...
        """
        from core_pdf.impl.third_party._vendor.fontTools.colorLib.builder import buildCPAL
