from core_pdf.impl.third_party._vendor.fontTools.misc.roundTools import noRound
...
from core_pdf.impl.third_party._vendor.fontTools.varLib import HVAR_FIELDS, VVAR_FIELDS, _add_VHVAR
from core_pdf.impl.third_party._vendor.fontTools.varLib import builder, models, varStore
from core_pdf.impl.third_party._vendor.fontTools.misc.fixedTools import fixedToFloat as fi2fl
...
def main(args=None):
    ...
    from core_pdf.impl.third_party._vendor.fontTools.designspaceLib import DesignSpaceDocument
    import argparse
