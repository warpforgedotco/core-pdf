...
import core_pdf.impl.third_party._vendor.fontTools.otlLib.builder as otl_lib_builder
from core_pdf.impl.third_party._vendor.fontTools.designspaceLib import (
    AxisLabelDescriptor,
    DesignSpaceDocument,
    DesignSpaceDocumentError,
    LocationLabelDescriptor,
)
from core_pdf.impl.third_party._vendor.fontTools.designspaceLib.types import Region, getVFUserRegion, locationInRegion
