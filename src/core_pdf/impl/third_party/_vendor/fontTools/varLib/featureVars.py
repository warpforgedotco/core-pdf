...
from core_pdf.impl.third_party._vendor.fontTools.misc.dictTools import hashdict
...
from core_pdf.impl.third_party._vendor.fontTools.otlLib.builder import buildLookup, buildSingleSubstSubtable
