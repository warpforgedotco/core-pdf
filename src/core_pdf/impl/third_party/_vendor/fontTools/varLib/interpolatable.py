...
from core_pdf.impl.third_party._vendor.fontTools.pens.statisticsPen import StatisticsPen, StatisticsControlPen
from core_pdf.impl.third_party._vendor.fontTools.pens.momentsPen import OpenContourError
from core_pdf.impl.third_party._vendor.fontTools.varLib.models import piecewiseLinearMap, normalizeLocation
from core_pdf.impl.third_party._vendor.fontTools.misc.fixedTools import floatToFixedToStr
from core_pdf.impl.third_party._vendor.fontTools.misc.transform import Transform
...
def main(args=None):
    ...
    for filename in args.inputs:
        if filename.endswith(".ufo"):
            from core_pdf.impl.third_party._vendor.fontTools.ufoLib import UFOReader
