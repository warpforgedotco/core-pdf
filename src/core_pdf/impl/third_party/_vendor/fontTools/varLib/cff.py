...
from core_pdf.impl.third_party._vendor.fontTools.cffLib import (
    maxStackLimit,
    TopDictIndex,
    buildOrder,
    topDictOperators,
...
from core_pdf.impl.third_party._vendor.fontTools.cffLib.specializer import specializeCommands, commandsToProgram
...
from core_pdf.impl.third_party._vendor.fontTools.varLib.models import allEqual
from core_pdf.impl.third_party._vendor.fontTools.misc.loggingTools import deprecateFunction
from core_pdf.impl.third_party._vendor.fontTools.misc.roundTools import roundFunc
from core_pdf.impl.third_party._vendor.fontTools.misc.psCharStrings import T2CharString, T2OutlineExtractor
from core_pdf.impl.third_party._vendor.fontTools.pens.t2CharStringPen import T2CharStringPen
