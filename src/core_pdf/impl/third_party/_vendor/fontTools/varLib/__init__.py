...
from core_pdf.impl.third_party._vendor.fontTools.misc.roundTools import noRound, otRound
from core_pdf.impl.third_party._vendor.fontTools.misc.fixedTools import floatToFixed as fl2fi
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import Tag, tostr
from core_pdf.impl.third_party._vendor.fontTools.ttLib import TTFont, newTable
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables._f_v_a_r import Axis, NamedInstance
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables._g_l_y_f import (
    GlyphCoordinates,
    dropImpliedOnCurvePoints,
    USE_MY_METRICS,
)
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.ttProgram import Program
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.TupleVariation import TupleVariation
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables import otTables as ot
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.otBase import OTTableWriter
from core_pdf.impl.third_party._vendor.fontTools.varLib import builder, models, varStore
from core_pdf.impl.third_party._vendor.fontTools.varLib.merger import VariationMerger, COLRVariationMerger
from core_pdf.impl.third_party._vendor.fontTools.varLib.mvar import MVAR_ENTRIES
from core_pdf.impl.third_party._vendor.fontTools.varLib.iup import iup_delta_optimize
from core_pdf.impl.third_party._vendor.fontTools.varLib.featureVars import addFeatureVariations
from core_pdf.impl.third_party._vendor.fontTools.designspaceLib import DesignSpaceDocument, InstanceDescriptor
from core_pdf.impl.third_party._vendor.fontTools.designspaceLib.split import splitInterpolable, splitVariableFonts
from core_pdf.impl.third_party._vendor.fontTools.varLib.stat import buildVFStatTable
from core_pdf.impl.third_party._vendor.fontTools.colorLib.builder import buildColrV1
from core_pdf.impl.third_party._vendor.fontTools.colorLib.unbuilder import unbuildColrV1
...
def _add_CFF2(varFont, model, master_fonts):
    ...
    if "CFF2" not in varFont:
        from core_pdf.impl.third_party._vendor.fontTools.cffLib.CFFToCFF2 import convertCFFToCFF2
...
def _open_font(path, master_finder=lambda s: s):
    ...
    from core_pdf.impl.third_party._vendor.fontTools.ttx import guessFileType
...
def main(args=None):
    ...
    from core_pdf.impl.third_party._vendor.fontTools import configLogger
