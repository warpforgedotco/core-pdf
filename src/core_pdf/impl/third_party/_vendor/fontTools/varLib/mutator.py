...
from core_pdf.impl.third_party._vendor.fontTools.misc.fixedTools import floatToFixedToFloat, floatToFixed
...
from core_pdf.impl.third_party._vendor.fontTools.pens.boundsPen import BoundsPen
...
from core_pdf.impl.third_party._vendor.fontTools.varLib.models import (
    supportScalar,
    normalizeLocation,
    piecewiseLinearMap,
)
...
from core_pdf.impl.third_party._vendor.fontTools.varLib.iup import iup_delta
import core_pdf.impl.third_party._vendor.fontTools.subset.cff as subset_cff
import os.path
import logging
