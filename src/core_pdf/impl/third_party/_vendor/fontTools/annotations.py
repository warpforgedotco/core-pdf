...
if TYPE_CHECKING:
    from core_pdf.impl.third_party._vendor.fontTools.ufoLib import UFOFormatVersion
    from core_pdf.impl.third_party._vendor.fontTools.ufoLib.glifLib import GLIFFormatVersion
