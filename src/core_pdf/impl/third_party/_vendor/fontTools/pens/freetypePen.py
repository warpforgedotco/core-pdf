...
from core_pdf.impl.third_party._vendor.fontTools.pens.basePen import BasePen, PenError
...
class FreeTypePen(BasePen):
    ...
    Examples:
        ...
        show the glyph image of `fi` in a new window::
            ...
            from core_pdf.impl.third_party._vendor.fontTools.pens.freetypePen import FreeTypePen
            from core_pdf.impl.third_party._vendor.fontTools.misc.transform import Offset
