...
from core_pdf.impl.third_party._vendor.fontTools.qu2cu import quadratic_to_curves
from core_pdf.impl.third_party._vendor.fontTools.pens.filterPen import ContourFilterPen
