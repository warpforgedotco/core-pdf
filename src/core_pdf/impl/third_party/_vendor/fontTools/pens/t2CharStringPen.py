...
from core_pdf.impl.third_party._vendor.fontTools.cffLib.specializer import commandsToProgram, specializeCommands
from core_pdf.impl.third_party._vendor.fontTools.misc.psCharStrings import T2CharString
from core_pdf.impl.third_party._vendor.fontTools.misc.roundTools import otRound, roundFunc
from core_pdf.impl.third_party._vendor.fontTools.pens.basePen import BasePen
