...
from core_pdf.impl.third_party._vendor.fontTools.misc.enumTools import StrEnum
from core_pdf.impl.third_party._vendor.fontTools.misc.loggingTools import LogMixin
from core_pdf.impl.third_party._vendor.fontTools.misc.transform import DecomposedTransform, Identity
from core_pdf.impl.third_party._vendor.fontTools.pens.basePen import AbstractPen, MissingComponentError, PenError
...
class DecomposingPointPen(LogMixin, AbstractPointPen):
    ...
    def addComponent(self, baseGlyphName, transformation, identifier=None, **kwargs):
        ...
        """
        from core_pdf.impl.third_party._vendor.fontTools.pens.transformPen import TransformPointPen
            ...
            if self.reverseFlipped != ReverseFlipped.NO:
                ...
                if a * d - b * c < 0:
                    ...
                    if self.reverseFlipped == ReverseFlipped.ON_CURVE_FIRST:
                        from core_pdf.impl.third_party._vendor.fontTools.pens.filterPen import OnCurveFirstPointPen
