...
from core_pdf.impl.third_party._vendor.fontTools.misc import psCharStrings
from core_pdf.impl.third_party._vendor.fontTools.misc.arrayTools import unionRect, intRect
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import (
    bytechr,
    byteord,
    bytesjoin,
    tobytes,
...
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.otBase import OTTableReader
