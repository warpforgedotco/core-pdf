...
from core_pdf.impl.third_party._vendor.fontTools.designspaceLib.statNames import StatNames, getStatNames
from core_pdf.impl.third_party._vendor.fontTools.designspaceLib.types import (
    ConditionSet,
    Range,
    Region,
    getVFUserRegion,
