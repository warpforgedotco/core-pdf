...
from core_pdf.impl.third_party._vendor.fontTools.misc import etree as ET
...
from core_pdf.impl.third_party._vendor.fontTools.misc.textTools import tobytes, tostr
...
class AxisDescriptor(AbstractAxisDescriptor):
    ...
    def map_forward(self, v):
        ...
        from core_pdf.impl.third_party._vendor.fontTools.varLib.models import piecewiseLinearMap
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    ...
    **Note:** Python attribute names are usually camelCased, the
    ...
    def normalizeLocation(self, location):
        ...
        from core_pdf.impl.third_party._vendor.fontTools.varLib.models import normalizeValue
