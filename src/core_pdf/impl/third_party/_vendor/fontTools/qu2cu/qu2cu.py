...
try:
    ...
    from core_pdf.impl.third_party._vendor.fontTools.misc import cython
COMPILED = cython.compiled

from core_pdf.impl.third_party._vendor.fontTools.misc.bezierTools import splitCubicAtTC
...
def main():
    from core_pdf.impl.third_party._vendor.fontTools.cu2qu.benchmark import generate_curve
    from core_pdf.impl.third_party._vendor.fontTools.cu2qu import curve_to_quadratic
