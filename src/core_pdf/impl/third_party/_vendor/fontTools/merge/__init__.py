...
import core_pdf.impl.third_party._vendor.fontTools.merge.base as merge_base
from core_pdf.impl.third_party._vendor.fontTools.merge.cmap import (
    computeMegaGlyphOrder,
    computeMegaCmap,
    renameCFFCharStrings,
)
from core_pdf.impl.third_party._vendor.fontTools.merge.layout import layoutPreMerge, layoutPostMerge
from core_pdf.impl.third_party._vendor.fontTools.merge.options import Options
import core_pdf.impl.third_party._vendor.fontTools.merge.tables as merge_tables
