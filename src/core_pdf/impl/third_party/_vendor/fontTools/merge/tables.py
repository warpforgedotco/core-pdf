...
from core_pdf.impl.third_party._vendor.fontTools import ttLib, cffLib
from core_pdf.impl.third_party._vendor.fontTools.misc.psCharStrings import T2WidthExtractor
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.DefaultTable import DefaultTable
from core_pdf.impl.third_party._vendor.fontTools.merge.base import add_method, mergeObjects
from core_pdf.impl.third_party._vendor.fontTools.merge.cmap import computeMegaCmap
from core_pdf.impl.third_party._vendor.fontTools.merge.util import *
import logging
