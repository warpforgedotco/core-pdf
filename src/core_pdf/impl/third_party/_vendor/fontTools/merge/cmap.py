...
from core_pdf.impl.third_party._vendor.fontTools.merge.unicode import is_Default_Ignorable
from core_pdf.impl.third_party._vendor.fontTools.pens.recordingPen import DecomposingRecordingPen
import logging
