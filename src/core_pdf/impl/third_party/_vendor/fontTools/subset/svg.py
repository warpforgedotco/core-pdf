...
from core_pdf.impl.third_party._vendor.fontTools.subset.util import _add_method
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.S_V_G_ import SVGDocument
