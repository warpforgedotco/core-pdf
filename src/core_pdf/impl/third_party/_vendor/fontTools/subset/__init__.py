...
from core_pdf.impl.third_party._vendor.fontTools import config
from core_pdf.impl.third_party._vendor.fontTools.misc.roundTools import otRound
from core_pdf.impl.third_party._vendor.fontTools import ttLib
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables import otTables
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables.otBase import USE_HARFBUZZ_REPACKER
from core_pdf.impl.third_party._vendor.fontTools.otlLib.maxContextCalc import maxCtxFont
from core_pdf.impl.third_party._vendor.fontTools.pens.basePen import NullPen
from core_pdf.impl.third_party._vendor.fontTools.misc.loggingTools import Timer
from core_pdf.impl.third_party._vendor.fontTools.misc.cliTools import makeOutputFileName
from core_pdf.impl.third_party._vendor.fontTools.subset.util import _add_method, _uniq_sort
from core_pdf.impl.third_party._vendor.fontTools.subset.cff import *
from core_pdf.impl.third_party._vendor.fontTools.subset.svg import *
from core_pdf.impl.third_party._vendor.fontTools.varLib import varStore, multiVarStore  # For monkey-patching
from core_pdf.impl.third_party._vendor.fontTools.ttLib.tables._n_a_m_e import NameRecordVisitor, makeName
from core_pdf.impl.third_party._vendor.fontTools.unicodedata import mirrored
import sys
import struct
import array
import logging
...
def subset_glyphs(self, s):
    ...
    from core_pdf.impl.third_party._vendor.fontTools.colorLib.builder import buildColrV1, populateCOLRv0
...
def save_font(font, outfile, options):
    if options.with_zopfli and options.flavor == "woff":
        from core_pdf.impl.third_party._vendor.fontTools.ttLib import sfnt
