...
import logging
from core_pdf.impl.third_party._vendor.fontTools.pens.basePen import AbstractPen
from core_pdf.impl.third_party._vendor.fontTools.pens.pointPen import PointToSegmentPen
