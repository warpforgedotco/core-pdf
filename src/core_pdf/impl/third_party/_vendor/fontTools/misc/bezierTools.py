...
from core_pdf.impl.third_party._vendor.fontTools.misc.arrayTools import calcBounds, sectRect, rectArea
from core_pdf.impl.third_party._vendor.fontTools.misc.transform import Identity
import math
