...
from core_pdf.impl.third_party.cid.encoding import BYTE_CACHE, decode_utf16be
from core_pdf.impl.third_party.cid.pdf_string import decode_pdf_literal_string
...
CMapResourceResolver = Callable[
    [str], typing.Union[bytes, bytearray, memoryview, "CMapDecoder", None]
]
