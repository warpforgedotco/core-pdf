...
from core_pdf.impl.third_party.fontTools.pens.basePen import AbstractPen, DecomposingPen
from core_pdf.impl.third_party.fontTools.pens.pointPen import AbstractPointPen, DecomposingPointPen
...
class RecordingPen(AbstractPen):
    ...
    :Example:
        .. code-block::
            ...
            from core_pdf.impl.third_party.fontTools.pens.recordingPen import RecordingPen
...
class RecordingPointPen(AbstractPointPen):
    ...
    :Example:
        .. code-block::
            ...
            from core_pdf.impl.third_party.fontTools.pens.recordingPen import RecordingPointPen
