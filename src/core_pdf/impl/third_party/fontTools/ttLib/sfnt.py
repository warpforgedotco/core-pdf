...
from core_pdf.impl.third_party.fontTools.ttLib import TTLibError, TTLibFileIsCollectionError
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if args and cls is SFNTReader:
            ...
            if sfntVersion == "wOF2":
                ...
                from core_pdf.impl.third_party.fontTools.ttLib.woff2 import WOFF2Reader
    ...
    def __getitem__(self, tag: str | bytes) -> bytes:
        ...
        if self.checkChecksums:
            ...
            if self.checkChecksums > 1:
                ...
                log.debug("bad checksum for '%s' table", tag)
        return data
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if cls is SFNTWriter:
            if flavor == "woff2":
                ...
                from core_pdf.impl.third_party.fontTools.ttLib.woff2 import WOFF2Writer
