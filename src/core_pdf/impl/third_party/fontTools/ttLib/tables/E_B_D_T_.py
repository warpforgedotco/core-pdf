        ...
        if name == "header":
            ...
            for element in content:
                ...
                if name[4:].startswith(_bitmapGlyphSubclassPrefix[4:]):
                    ...
                    log.debug("%s being ignored by %s", name, self.__class__.__name__)
    ...
    def fromXML(self, name, attrs, content, ttFont):
        ...
        for element in content:
            ...
            if name in componentNames:
                ...
                log.debug("unknown name '%s' being ignored by EbdtComponent.", name)
            ...
            if name == "components":
                ...
                for compElement in content:
                    ...
                    if name == "ebdtComponent":
                        ...
                        log.debug("'%s' being ignored in component array.", name)
