...
from core_pdf.impl.third_party.fontTools.misc import xmlWriter
from core_pdf.impl.third_party.fontTools.misc.configTools import AbstractConfig
from core_pdf.impl.third_party.fontTools.misc.loggingTools import deprecateArgument
from core_pdf.impl.third_party.fontTools.misc.textTools import Tag, byteord, tostr
from core_pdf.impl.third_party.fontTools.ttLib import TTLibError
from core_pdf.impl.third_party.fontTools.ttLib.sfnt import SFNTReader, SFNTWriter
from core_pdf.impl.third_party.fontTools.ttLib.ttGlyphSet import (
    _TTGlyph,  # noqa: F401
    _TTGlyphSet,
    _TTGlyphSetCFF,
    _TTGlyphSetGlyf,
...
if TYPE_CHECKING:
    ...
    from core_pdf.impl.third_party.fontTools.ttLib.tables import (
        B_A_S_E_,
        C_B_D_T_,
        C_B_L_C_,
        C_F_F_,
...
class TTFont(object):
    ...
    def _saveXML(
        ...
        if writeVersion:
            from core_pdf.impl.third_party.fontTools import version
    ...
    def importXML(
        ...
        from core_pdf.impl.third_party.fontTools.misc import xmlReader
    ...
    def _makeGlyphName(codepoint: int) -> str:
        from core_pdf.impl.third_party.fontTools import agl  # Adobe Glyph List
    ...
    def getGlyphNames2(self) -> list[str]:
        ...
        """
        from core_pdf.impl.third_party.fontTools.misc import textTools
    ...
    def normalizeLocation(self, location: Mapping[str, float]) -> dict[str, float]:
        ...
        """
        from core_pdf.impl.third_party.fontTools.varLib.models import normalizeLocation
...
def getTableModule(tag: str | bytes) -> ModuleType | None:
    ...
    """
    from .tables import get_table_module

    return get_table_module(tagToIdentifier(tag))


# Registry for custom table packer/unpacker classes. Keys are table tags.
# See registerCustomTableClass() and getCustomTableClass()
_customTableRegistry: dict[str | bytes, type[DefaultTable]] = {}


def registerCustomTableClass(tag: str | bytes, tableClass: type[DefaultTable]) -> None:
    """Register a custom packer/unpacker class for a table.

    The registered table class should be a subclass of
    :py:class:`fontTools.ttLib.tables.DefaultTable.DefaultTable`
    """
    _customTableRegistry[tag] = tableClass
...
def getCustomTableClass(tag: str | bytes) -> type[DefaultTable] | None:
    ...
    """
    return _customTableRegistry.get(tag)
