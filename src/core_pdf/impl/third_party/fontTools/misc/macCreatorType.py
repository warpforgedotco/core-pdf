from core_pdf.impl.third_party.fontTools.misc.textTools import Tag, bytesjoin, strjoin
...
def setMacCreatorAndType(path, fileCreator, fileType):
    ...
    """
    if xattr is not None:
        from core_pdf.impl.third_party.fontTools.misc.textTools import pad
