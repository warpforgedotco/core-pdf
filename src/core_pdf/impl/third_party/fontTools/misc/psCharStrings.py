...
class T2CharString(object):
    ...
    def toXML(self, xmlWriter, ttFont=None):
        from core_pdf.impl.third_party.fontTools.misc.textTools import num2binary
    ...
    def fromXML(self, name, attrs, content):
        from core_pdf.impl.third_party.fontTools.misc.textTools import binary2num, readHex
