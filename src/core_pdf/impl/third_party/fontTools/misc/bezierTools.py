...
from core_pdf.impl.third_party.fontTools.misc.arrayTools import calcBounds, rectArea, sectRect
from core_pdf.impl.third_party.fontTools.misc.transform import Identity
