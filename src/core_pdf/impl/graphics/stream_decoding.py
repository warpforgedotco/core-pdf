...
from core_pdf.impl.graphics.decode_compat import normalize_stream_decode_spec
from core_pdf.impl.graphics.filter_recovery import (
    apply_ascii85,
    apply_ascii_hex,
    apply_flate,
    apply_lzw,
...
from core_pdf.impl.graphics.predictor_backends import apply_predictor
