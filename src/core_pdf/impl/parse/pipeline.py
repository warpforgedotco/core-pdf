...
from core_pdf.impl.parse.fusion import (
    fuse_observations,
)
from core_pdf.impl.parse.layout import layout_blocks_with_evidence
...
from core_pdf.impl.parse.route import (
    plan_page,
)
...
class internal_PageExtraction:
    ...
    def recognition(self, context: TaskScope) -> RecognitionResult:
        with self.page.internal_page_lock:
            ...
            plan = self.plan()
            if plan.ocr_passes:
                from core_pdf.impl.parse.ocr import recognize_page
...
def internal_document_stroked_recognition(
    ...
    *,
    ...
    from core_pdf.impl.parse.ocr_stroked_vector import internal_stroked_vector_decoded_batch
...
def internal_prepare_document_stroked_mappings(
    ...
    from core_pdf.impl.parse.ocr_stroked_vector import internal_stroked_text_profile
