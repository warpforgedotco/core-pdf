---
fixture: BarrowArchAnalysis_Alaska1984-p076.pdf
rotation: 90
page_class: table
...
```text
PORT CAPACITY AT ANCHORAGE, WHITTIER, AND
```
...
```text
Pacific Western Cement
```
<!-- line: 011; break_before: 2; kind: native_line; source: native_text -->
```text
Pacific Western Cargo 856
```
<!-- line: 012; break_before: 2; kind: native_line; source: native_text -->
```text
Kaiser Cement
```
<!-- line: 013; break_before: 2; kind: native_line; source: native_text -->
```text
TOTAL 2,046 3,169
```
<!-- line: 014; break_before: 2; kind: native_line; source: native_text -->
```text
Port of Whittier
```
