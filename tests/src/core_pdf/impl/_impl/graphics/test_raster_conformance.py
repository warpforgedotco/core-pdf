...
from core_pdf.impl._impl.graphics.functions import internal_evaluate_pdf_function
from core_pdf.impl._impl.graphics.images import ImageSource, decode_image
...
def internal_alpha(dictionary: dict[str, object]) -> list[int]:
    raster = decode_image(ImageSource(ONE_HIGH_BIT, dictionary))
