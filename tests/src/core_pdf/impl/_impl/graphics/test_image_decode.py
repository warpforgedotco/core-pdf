...
from core_pdf.impl._impl.graphics.color import internal_convert_cmyk
from core_pdf.impl._impl.graphics.images import (
    ImageSource,
    SoftMask,
    decode_image,
    decode_pdf_image,
...
def test_image_source_decodes_into_read_only_ndarray() -> None:
    ...
    first = decode_image(source)
    second = decode_image(source)
