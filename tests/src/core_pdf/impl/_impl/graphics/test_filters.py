...
from core_pdf.impl._impl.graphics import predictor_backends as predictors
...
from core_pdf.impl._impl.graphics.filter_registry import PREDICTOR_FILTERS, declared_filter_names
from core_pdf.impl._impl.graphics.image_kernels import (
    unpack_subbyte_image_samples,
)
from core_pdf.impl._impl.graphics.predictor_backends import (
    apply_png_predictor,
...
def test_png_predictor_codec_path_matches_scalar_path(
    ...
    from core_pdf.impl._impl.graphics import predictor_backends as predictor_impl
