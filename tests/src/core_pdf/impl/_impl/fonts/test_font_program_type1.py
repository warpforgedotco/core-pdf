...
from core_pdf.impl._impl.fonts import font_program_type1
from core_pdf.impl.spec.s_09_fonts import font_program_type1 as type1_format
...
def test_type1_binary_entries_preserve_duplicates_and_skip_truncated_payloads() -> None:
    ...
    entries = list(
        font_program_type1.Type1FontProgram.binary_entries(
            data, type1_format.internal_CHARSTRING_RE
        )
    )
