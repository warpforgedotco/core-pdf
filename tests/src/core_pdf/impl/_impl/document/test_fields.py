...
from core_pdf.impl._impl.document.document import PdfDocument as SpecPdfDocument
from core_pdf.impl._impl.document.fields import collect_field_records, field_value_text
