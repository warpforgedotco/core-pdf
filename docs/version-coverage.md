...
None-colorant suppression, NChannel process conversion/selected spot approximation, and RGB
group isolation/non-isolated composition above
are implemented. The historical font
audit distinguishes actual encoding changes from clarified or implementation-specific
mapping rules. Further chapter work includes NChannel mixing hints and plate-aware output, halftones, arbitrary
transparency-group blending spaces and knockout behavior, Type 3 glyph programs, and the remaining
partial/gap rows.
