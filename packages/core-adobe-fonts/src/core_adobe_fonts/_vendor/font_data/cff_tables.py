...
"""CFF predefined strings and charsets from fontTools, following the CFF standard.

See README.md and the adjacent license notices for provenance.
"""
...
# fmt: off
CFF_STANDARD_STRINGS: tuple[str, ...] = (
...
CFF_ISO_ADOBE_STRINGS: tuple[str, ...] = (
    '.notdef', 'space', 'exclam', 'quotedbl',
    'numbersign', 'dollar', 'percent', 'ampersand',
    'quoteright', 'parenleft', 'parenright', 'asterisk',
    'plus', 'comma', 'hyphen', 'period',
...
CFF_EXPERT_STRINGS: tuple[str, ...] = (
    ...
    'nsuperior', 'osuperior', 'rsuperior', 'ssuperior',
    'tsuperior', 'ff', 'fi', 'fl',
    'ffi', 'ffl', 'parenleftinferior', 'parenrightinferior',
    'Circumflexsmall', 'hyphensuperior', 'Gravesmall', 'Asmall',
    'Bsmall', 'Csmall', 'Dsmall', 'Esmall',
    'Fsmall', 'Gsmall', 'Hsmall', 'Ismall',
    'Jsmall', 'Ksmall', 'Lsmall', 'Msmall',
    'Nsmall', 'Osmall', 'Psmall', 'Qsmall',
    'Rsmall', 'Ssmall', 'Tsmall', 'Usmall',
    'Vsmall', 'Wsmall', 'Xsmall', 'Ysmall',
    'Zsmall', 'colonmonetary', 'onefitted', 'rupiah',
    ...
    'oneeighth', 'threeeighths', 'fiveeighths', 'seveneighths',
    'onethird', 'twothirds', 'zerosuperior', 'onesuperior',
...
CFF_EXPERT_SUBSET_STRINGS: tuple[str, ...] = (
    ...
    'osuperior', 'rsuperior', 'ssuperior', 'tsuperior',
    'ff', 'fi', 'fl', 'ffi',
