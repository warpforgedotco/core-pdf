...
from core_filters.impl.codecs import (
...
from core_filters.impl.decoders import (
...
from core_filters.impl.syntax import full_source_bytes
...
def decode_stream_data(
    ...
    *,
    ...
    if len(filters) == 1:
        ...
        if fn is None:
            raise FilterUnsupportedError(f"stream filter {flt} is not implemented yet")
